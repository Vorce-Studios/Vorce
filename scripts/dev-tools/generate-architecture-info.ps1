# SubI Architecture Generation Script
...
Write-Host "Generating SubI Architecture Info..." -ForegroundColor Cyan

$Content = "# SubI Module Tree (Generated: $(Get-Date -Format 'yyyy-MM-dd HH:mm'))`n`n"
