...
- [ ] **VOR-23:** Verify Windows Installer (WiX) DLL bundling and shortcuts (Version updated to 0.2.0)
...
- [x] **VOR-42:** Merged Media Browser Decomposition (#613) and egui-wgpu update (#672) into main
