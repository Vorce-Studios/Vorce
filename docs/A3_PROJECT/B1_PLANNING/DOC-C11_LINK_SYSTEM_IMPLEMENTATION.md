...
- **File**: `crates/subi-core/src/module.rs`
...
In `subi-core/src/module_eval.rs` or `subi-ui/src/module_canvas.rs`:
- **Master Evaluation**:
...
1.  **Update Core Data Structures** (`crates/subi-core/src/module.rs`)
...
2.  **Update Module Construction** (`crates/subi-core/src/module.rs`)
...
3.  **Update UI Panels** (`crates/subi-ui/src/module_canvas/panels/`)
