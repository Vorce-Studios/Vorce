...
```yaml
# crates/stagegraph-ui/locales/en.yml
en:
  # Fenster-Titel
  window:
...
|-------|-------------------|---------|
| `crates/stagegraph-ui/src/lib.rs` | ~150 | 4h |
| `crates/stagegraph-ui/src/dashboard.rs` | ~30 | 1h |
| `crates/stagegraph/src/main.rs` | ~20 | 1h |
| **Gesamt** | ~200 | 6h |
