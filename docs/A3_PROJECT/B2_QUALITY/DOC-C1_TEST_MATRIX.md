...
| SRC-029 | User_2026-03-06 | Fixe ERROR stagegraph_control::hue::controller: Failed to connect to Hue Bridge DTLS... OpenSSL not compiled in. |
...
| SRC-033 | User_2026-03-06 | ERROR stagegraph_control::hue::controller ... OpenSSL support is not compiled in (erneut genannt). |
...
| SRC-060 | Codeanalyse_2026-03-06 | UIAction SelectAudioDevice/UpdateAudioConfig/ToggleAudioPanel in stagegraph-ui definiert, in app/actions nicht behandelt. |
