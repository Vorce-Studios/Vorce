...
## Plan-Überblick
Dieser Plan integriert die bereits existierende, aber bisher nur in Tests verwendete `FramePipeline` (aus `mapmap-media`) in die Haupt-Rendering-Schleife der Anwendung.
...
- **Validierung**: `cargo check -p mapmap`
