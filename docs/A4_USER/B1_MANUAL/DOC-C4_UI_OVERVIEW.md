...
This guide provides a detailed overview of the user interface panels in Vorce. Vorce's UI is designed to be modular and flexible, allowing you to arrange panels to suit your workflow.

## Overview

Vorce's interface is built around a docking system. You can drag panel tabs to rearrange them, or use the **View** menu to show/hide specific panels.
...
![Screenshot: Vorce Default Workspace Layout](docs/assets/missing/vorce-default-workspace.png)
...
The Module Canvas is the heart of Vorce's node-based workflow. Here you connect different modules to create your visual signal flow.
...
- **Displays**: Assign Vorce outputs to physical monitors or projectors.
