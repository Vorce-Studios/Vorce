...
*   **`stagegraph://resources/list`**: Lists all available resources.
*   **`stagegraph://app/state`**: Read-only access to the full application state (JSON).
*   **`stagegraph://layers`**: List of layers.
*   **`stagegraph://cues`**: List of cues.
