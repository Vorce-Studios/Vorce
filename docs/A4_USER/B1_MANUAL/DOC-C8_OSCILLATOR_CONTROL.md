...
**File:** `/home/user/stagegraph/crates/stagegraph-ui/src/lib.rs`
...
1. Launch StageGraph application
2. Open View menu
...
- **Config Definition:** `crates/stagegraph-core/src/oscillator.rs`
- **Renderer:** `crates/stagegraph-render/src/oscillator_renderer.rs`
- **Shaders:**
  - `shaders/oscillator_simulation.wgsl`
  - `shaders/oscillator_distortion.wgsl`
- **UI Implementation:** `crates/stagegraph-ui/src/lib.rs`
