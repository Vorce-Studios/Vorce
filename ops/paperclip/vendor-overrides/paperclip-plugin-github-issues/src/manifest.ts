...
const manifest: PaperclipPluginManifestV1 = {
  ...
  instanceConfigSchema: {
    ...
    properties: {
      ...
      defaultRepo: {
        ...
        description: "Default repo in owner/repo format for agent tool searches",
  ...
  tools: [
    ...
    },
    {
      ...
      description:
        "Link a GitHub issue to a Paperclip issue for bidirectional sync.",
      parametersSchema: {
        type: "object",
        properties: {
          ghIssueUrl: {
          ...
          paperclipIssueId: {
            type: "string",
            description: "Target Paperclip issue UUID to link",
          },
        },
    ...
    },
    {
      ...
      description:
        "Remove the sync link between a GitHub issue and a Paperclip issue.",
      parametersSchema: {
        type: "object",
        properties: {
          paperclipIssueId: {
            type: "string",
            description: "Target Paperclip issue UUID to unlink",
          },
        },
