...
content = content.replace('module.add_connection(t_id, "trigger_out".to_string(), m_id, "trigger_in".to_string());', 'module.add_connection(t_id, format!("trigger_{}_event_out", t_id), m_id, format!("fx_{}_trigger_in", m_id));')
