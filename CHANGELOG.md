...
## [Unreleased]
- 2026-03-18: fix(ci): Fix missing `toolchain` input and repair platform logic in self-hosted post-merge workflow (switched to `powershell` for Windows compatibility).
