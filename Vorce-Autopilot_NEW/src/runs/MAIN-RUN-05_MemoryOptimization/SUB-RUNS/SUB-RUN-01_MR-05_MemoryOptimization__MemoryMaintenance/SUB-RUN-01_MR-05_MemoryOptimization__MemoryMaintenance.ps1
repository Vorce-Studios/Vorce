...
$partRuns = @(
    @{ name = "PART-RUN-01_MR-05_MemoryOptimization__MemoryMaintenance__OptimizeMemoryStore"; script = (Join-Path $PSScriptRoot "PART-RUNS/PART-RUN-01_MR-05_MemoryOptimization__MemoryMaintenance__OptimizeMemoryStore.ps1") }
)
