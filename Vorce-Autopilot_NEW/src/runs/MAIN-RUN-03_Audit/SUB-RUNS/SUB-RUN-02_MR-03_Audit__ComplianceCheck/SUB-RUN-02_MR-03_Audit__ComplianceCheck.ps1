# SUB-RUN-02_MR-03_Audit__ComplianceCheck.ps1 (Vorce 3.0)
...
$partRuns = @(
    @{ name = "PART-RUN-01_MR-03_Audit__ComplianceCheck__EvaluateCompliance"; script = (Join-Path $PSScriptRoot "PART-RUNS/PART-RUN-01_MR-03_Audit__ComplianceCheck__EvaluateCompliance.ps1") }
)
