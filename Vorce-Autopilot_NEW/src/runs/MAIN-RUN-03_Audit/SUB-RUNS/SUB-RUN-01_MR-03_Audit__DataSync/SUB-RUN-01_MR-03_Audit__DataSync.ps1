# SUB-RUN-01_MR-03_Audit__DataSync.ps1 (Vorce 3.0)
...
$partRuns = @(
    @{ name = "PART-RUN-01_MR-03_Audit__DataSync__ValidateDataSources"; script = (Join-Path $PSScriptRoot "PART-RUNS/PART-RUN-01_MR-03_Audit__DataSync__ValidateDataSources.ps1") }
)

return Invoke-VorceSubRunSequential -SubRunName "SUB-RUN-01_MR-03_Audit__DataSync" -PartRuns $partRuns -ConfigBag $ConfigBag -ParentState $ParentState
