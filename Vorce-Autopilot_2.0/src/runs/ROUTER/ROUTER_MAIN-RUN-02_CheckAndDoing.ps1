...
Add-Def -Name "SessionSync" -Script "src/runs/SUB-RUN/SUB-RUN-01_MR-02_CheckAndDoing__SessionSync.ps1"
...
if ($julesDelegations.Count -gt 0) {
    Add-Def -Name "JulesCheck" -Script "src/runs/SUB-RUN/SUB-RUN-02_MR-02_CheckAndDoing__JulesCheck.ps1"
...
if ($localDelegations.Count -gt 0) {
    Add-Def -Name "LocalAgentCheck" -Script "src/runs/SUB-RUN/SUB-RUN-03_MR-02_CheckAndDoing__LocalAgentCheck.ps1"
...
if ($hasPendingReviews -or $hasOpenDelegations) {
    Add-Def -Name "ReviewDispatch" -Script "src/runs/SUB-RUN/SUB-RUN-04_MR-02_CheckAndDoing__ReviewDispatch.ps1"
...
Add-Def -Name "Housekeeping" -Script "src/runs/SUB-RUN/SUB-RUN-06_MR-02_CheckAndDoing__Housekeeping.ps1"
