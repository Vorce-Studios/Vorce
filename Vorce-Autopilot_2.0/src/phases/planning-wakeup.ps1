...
"@
    ...
    if ($Config.PSObject.Properties.Name -contains "planning_sequence") {
        ...
        foreach ($step in $Config.planning_sequence) {
            ...
            if (-not $useCodex) {
                $partName = "PART-RUN-01_SR-02_MR-01_Planning__$($step.label -replace '[^A-Za-z0-9]', '-')"
...
"@
            $partName = "PART-RUN-01_SR-02_MR-01_Planning__IssueProposal"
...
"@
            ...
            $partName = "PART-RUN-01_SR-02_MR-01_Planning__MemoryOptimization"
...
"@
            ...
            $partName = "PART-RUN-01_SR-02_MR-01_Planning__OptimizerAnalysis"
