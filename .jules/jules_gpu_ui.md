...
### 1. GPU Selection Backend (`crates/stagegraph-render/src/backend.rs`)
...
### 2. Settings UI (`crates/stagegraph-ui/src/settings_panel.rs`)
...
### 4. configuration Persistence (`crates/stagegraph-ui/src/config.rs`)
