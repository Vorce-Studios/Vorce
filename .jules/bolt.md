...
**Optimierung (Rayon):** Das Lesen und Parsen der JSON-Dateien im Hintergrund-Thread wurde zusätzlich parallelisiert (Rayon `par_iter`), um die Multi-Core-Performance bei großen Asset-Bibliotheken optimal zu nutzen.
