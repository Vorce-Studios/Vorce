...
## 2023-10-27 - Parallel Asset Loading
**Erkenntnis:** The sequential read of many JSON configuration files from disk blocked the main thread.
**Aktion:** The loading of effect presets, transform presets, and project templates has been parallelized using `rayon::prelude::*`, reducing loading times by ~67%.
