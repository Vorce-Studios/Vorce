...
**Action:** Fixed `crates/stagegraph/README.md`, `docs/user/getting-started/BUILD.md`, `docs/project/cicd/WORKFLOW_CONTROL.md`, `docs/project/cicd/WORKFLOW_QUICKREF.md`, and `docs/project/audits/DOCUMENTATION_AUDIT.md` to point to the correct semantic documentation paths.
...
**Erkenntnis:** The `crates/stagegraph/README.md` was still pointing to the old documentation structure (`docs/user/getting-started/`, `docs/user/manual/`, `docs/dev/architecture/`).
**Aktion:** Updated the markdown links in `crates/stagegraph/README.md` to point to the new semantic paths `docs/A4_USER/B1_MANUAL/DOC-C2_QUICKSTART.md`, `docs/A4_USER/B1_MANUAL/DOC-C0_README.md`, and `docs/A1_SYSTEM/B1_ARCHITECTURE/DOC-C1_OVERVIEW.md`.
