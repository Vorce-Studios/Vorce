...
sed -i 's/_ui\.label("Animation and sequencing controls will be here.");/ui.label("Animation and sequencing controls will be here.");/' crates/subi/src/app/ui_layout.rs
