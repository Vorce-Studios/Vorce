...
Antworte mit einem konkreten, korrigierten Handlungsplan für Jules, folgend dieser Struktur:

# 1. Analyse des Fehlschlags
[Was ist beim letzten Versuch schiefgelaufen? Warum ist Jules gescheitert?]

# 2. Korrigierte Handlungsanweisung
[Neue, präzise Instruktionen für Jules, die das Problem umgehen oder klären]

# 3. Empfehlung an den QA-Manager
[Was soll der QA-Manager besonders beim Code-Review beachten?]
"@
