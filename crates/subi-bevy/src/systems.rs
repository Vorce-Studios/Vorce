...
pub fn shape_system(
    ...
    for (entity, shape) in query.iter() {
        let mesh = match shape.shape_type {
            subi_core::module::BevyShapeType::Cube => Mesh::from(Cuboid::default()),
            subi_core::module::BevyShapeType::Sphere => Mesh::from(Sphere::default()),
            subi_core::module::BevyShapeType::Capsule => Mesh::from(Capsule3d::default()),
            subi_core::module::BevyShapeType::Torus => Mesh::from(Torus::default()),
            subi_core::module::BevyShapeType::Cylinder => Mesh::from(Cylinder::default()),
            subi_core::module::BevyShapeType::Plane => Mesh::from(Plane3d::default()),
        };
