...
//!
//! This module provides a REST API and WebSocket interface for remote control of SubI.
//!
//! ## REST API Endpoints
//!
...
//!
//! ```rust,no_run
//! use subi_control::web::{WebServer, WebServerConfig};
//!
//! # #[cfg(feature = "http-api")]
//! # #[tokio::main]
//! # async fn main() -> subi_control::Result<()> {
...
//!
//! ```rust
//! use subi_control::web::{WebServerConfig, auth::AuthConfig};
//!
