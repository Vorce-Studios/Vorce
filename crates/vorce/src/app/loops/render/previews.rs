        ...
        app.cached_output_infos = app
            ...
            .filter_map(|(mid, part)| {
                if let vorce_core::module::ModulePartType::Output(
                    vorce_core::module::OutputType::Projector { id, .. },
                ) = &part.part_type
                {
                ...
                module
                    ...
                    .map(|part| {
                        let media_path = match &part.part_type {
                            vorce_core::module::ModulePartType::Source(
                                vorce_core::module::SourceType::MediaFile { path, .. }
                                | vorce_core::module::SourceType::VideoUni { path, .. }
                                | vorce_core::module::SourceType::ImageUni { path, .. },
                            ) if !path.trim().is_empty() => Some(path.clone()),
                            vorce_core::module::ModulePartType::Source(
                                vorce_core::module::SourceType::VideoMulti { shared_id, .. }
                                | vorce_core::module::SourceType::ImageMulti { shared_id, .. },
                            ) => app
                                .state
                                .module_manager
                                .shared_media
