use stagegraph_core::module::{MapFlowModule, ModulePartType, ModulePlaybackMode, TriggerType};
use stagegraph_core::module_eval::ModuleEvaluator;
...
fn test_manual_trigger() {
    ...
    let shared = stagegraph_core::module::SharedMediaState::default();
...
fn test_osc_trigger() {
    ...
    let mut shared = stagegraph_core::module::SharedMediaState::default();
