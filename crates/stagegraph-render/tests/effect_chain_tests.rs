...
use stagegraph_core::{EffectChain, EffectType};
use stagegraph_render::{EffectChainRenderer, WgpuBackend};
use std::sync::Arc;
...
async fn test_simple_invert() {
    ...
    let shader_graph_manager = stagegraph_render::ShaderGraphManager::new();
