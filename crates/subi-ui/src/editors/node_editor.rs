...
pub use subi_core::shader_graph::{DataType, GraphId, NodeType, ParameterValue};
...
impl NodeEditor {
    ...
    pub fn load_graph(&mut self, graph: &subi_core::shader_graph::ShaderGraph) {
    ...
    fn core_node_to_ui(&self, core_node: &subi_core::shader_graph::ShaderNode) -> Node {
    ...
    pub fn add_node(&mut self, node_type: NodeType, position: Pos2) -> NodeId {
        ...
        let core_node = subi_core::shader_graph::ShaderNode::new(id, node_type);
