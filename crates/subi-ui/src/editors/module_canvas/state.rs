...
pub struct ModuleCanvas {
    ...
    pub clipboard: Vec<(subi_core::module::ModulePartType, (f32, f32))>,
    /// Search filter text
    ...
    pub diagnostic_issues: Vec<subi_core::diagnostics::ModuleIssue>,
    ...
    pub hue_bridges: Vec<subi_control::hue::api::discovery::DiscoveredBridge>,
    /// Channel for Hue discovery results
    pub hue_discovery_rx: Option<
        std::sync::mpsc::Receiver<
            Result<Vec<subi_control::hue::api::discovery::DiscoveredBridge>, String>,
        >,
    >,
    ...
    pub edit_snapshot: Option<subi_core::module::ModulePart>,
}
