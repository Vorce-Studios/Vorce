...
pub fn render_layer_inspector(
    ...
    transform: &Transform,
    _index: usize,
    first_mapping: Option<&subi_core::mapping::Mapping>,
    i18n: &LocaleManager,
            ...
            .show(ui, |ui| {
                if let Some(mapping) = first_mapping {
                    ...
                    if let Some(_edit_action) = mesh_editor.ui(ui) {
                        ...
                        if new_mesh.mesh_type == subi_core::mesh::MeshType::Quad {
                    ...
                    if ui.button("Reset Mesh").clicked() {
                        let mut reset_mesh = subi_core::Mesh::quad();
