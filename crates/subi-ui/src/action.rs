...
pub enum UIAction {
    ...
    SetLoopMode(subi_media::LoopMode),
    ...
    SelectMapping(u64),
    /// Update mapping mesh
    UpdateMappingMesh(u64, subi_core::Mesh),
    ...
    SetLayerBlendMode(u64, subi_core::BlendMode),
    ...
    /// Set layer transform
    SetLayerTransform(u64, subi_core::Transform),
    /// Apply resize mode to layer
    ApplyResizeMode(u64, subi_core::ResizeMode),
    ...
    /// Add new output
    AddOutput(String, subi_core::CanvasRegion, (u32, u32)),
    /// Remove output by ID
    RemoveOutput(u64),
    /// Configure output settings
    ConfigureOutput(u64, subi_core::OutputConfig),
    /// Set output edge blend configuration
    SetOutputEdgeBlend(u64, subi_core::EdgeBlendConfig),
    /// Set output color calibration
    SetOutputColorCalibration(u64, subi_core::ColorCalibration),
    ...
    UpdateAudioConfig(subi_core::audio::AudioConfig),
    ...
    RemoveCue(u32),
    /// Update cue data
    UpdateCue(Box<subi_control::cue::Cue>),
    ...
    OpenShaderGraph(subi_core::GraphId),
    ...
    DeleteConnection(
        subi_core::module::ModuleId,
        subi_core::module::ModuleConnection,
    ),
}
