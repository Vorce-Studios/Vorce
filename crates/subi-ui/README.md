...
The user interface layer for SubI, built with `egui`.

## Overview

This crate contains all the UI components, panels, and widgets that make up the SubI application.
...
SubI features a customizable theming system ("Cyber Dark") designed for low-light environments typical of live performances,
