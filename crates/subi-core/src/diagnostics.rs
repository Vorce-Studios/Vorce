...
//! - **check_module_integrity**: Main function to validate a `SubIModule`.

use crate::module::{SubIModule, ModulePartType};
...
pub fn check_module_integrity(module: &SubIModule) -> Vec<ModuleIssue> {
...
mod tests {
    use super::*;
    use crate::module::{SubIModule, ModulePlaybackMode, PartType};
