...
impl LogConfig {
    ...
    pub fn generate_log_filename() -> String {
        ...
        format!("subi_{}.log", now.format("%Y-%m-%d_%H-%M-%S"))
    }
...
mod tests {
    ...
    fn test_log_filename_format() {
        ...
        assert!(filename.starts_with("subi_"));
    ...
    fn test_current_log_path() {
        ...
        assert!(path.to_string_lossy().contains("subi_"));
    ...
    fn test_cleanup_old_logs() {
        ...
        let file1 = log_dir.join("subi_1.log");
        let file2 = log_dir.join("subi_2.log");
        let file3 = log_dir.join("subi_3.log");
