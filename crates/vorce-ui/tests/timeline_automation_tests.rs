use vorce_ui::editors::timeline_v2::{
    state::TimelineState, ModuleArrangementItem, ShowMode, TimelineV2,
};
...
fn test_timeline_fully_automated_switch() {
    ...
    let mod_id = timeline.state.runtime_show_module(
        timeline.show_control_enabled,
        timeline.show_mode,
        5.0,
        true,
        &available_ids,
