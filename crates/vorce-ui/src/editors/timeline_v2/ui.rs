    ...
    pub fn ui(
        ...
        egui::ScrollArea::both().show(ui, |ui| {
            ...
            while time <= duration {
                ...
                if x >= rect.min.x && x <= rect.max.x {
                    painter.line_segment(
                        ...
                        Stroke::new(1.0, ui.visuals().text_color().gamma_multiply(0.3)),
                    );
            ...
            if module_track_height > 0.0 {
                ...
                painter.rect_filled(module_rect, 0.0, ui.visuals().window_fill);
                painter.text(
                ...
                for block in self.sorted_enabled_blocks() {
                    ...
                    let color = if self.semi_auto_pending_block_id == Some(block.id) {
                        ui.visuals().warn_fg_color.gamma_multiply(0.7)
