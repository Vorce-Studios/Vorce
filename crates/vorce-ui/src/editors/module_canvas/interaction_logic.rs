use vorce_core::module::ModulePartId;
...
impl ModuleCanvas {
    ...
    pub fn set_audio_data(&mut self, data: vorce_core::audio_reactive::AudioTriggerData) {
        self.audio_trigger_data = data;
    }

    pub fn get_audio_trigger_data(&self) -> Option<&vorce_core::audio_reactive::AudioTriggerData> {
    ...
    #[cfg(feature = "midi")]
    pub fn process_midi_message(&mut self, message: vorce_control::midi::MidiMessage) {
