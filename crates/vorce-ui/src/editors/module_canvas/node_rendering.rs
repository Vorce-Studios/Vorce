use crate::UIAction;
use egui::Ui;
use vorce_core::module::EffectType as ModuleEffectType;
...
impl ModuleCanvas {
    pub fn sync_mesh_editor_to_current_selection(
        ...
        part: &vorce_core::module::ModulePart,
    ) {
    ...
    pub fn apply_mesh_editor_to_selection(
        ...
        part: &mut vorce_core::module::ModulePart,
    ) {
    ...
    pub fn render_mesh_editor_ui(
        ...
        last_mesh_edit_id: &mut Option<u64>,
        ui: &mut Ui,
        mesh: &mut vorce_core::module::MeshType,
    ...
    pub fn render_inspector_for_part(
        ...
        if interacting && (self.edit_snapshot.is_none() || self.edit_snapshot.as_ref().unwrap().id != part.id) {
