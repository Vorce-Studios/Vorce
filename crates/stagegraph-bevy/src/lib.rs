...
//!
//! ```rust,no_run
//! use stagegraph_bevy::BevyRunner;
//!
...
impl BevyRunner {
    ...
    pub fn update(
        &mut self,
        audio_data: &stagegraph_core::audio_reactive::AudioTriggerData,
    ...
    pub fn apply_graph_state(&mut self, module: &stagegraph_core::module::MapFlowModule) {
        use stagegraph_core::module::{ModulePartType, SourceType};
                        ...
                        match source_type {
                            ...
                            SourceType::BevyCamera { mode, fov, active } => {
                                    ...
                                    world.get_mut::<crate::components::BevyCamera>(entity)
                                {
                                    ...
                                    c.mode = match mode {
                                        stagegraph_core::module::BevyCameraMode::Orbit {
                                            radius,
                                            speed,
                                            target,
                                            height,
                                        ...
                                        stagegraph_core::module::BevyCameraMode::Fly {
                                            speed,
                                            sensitivity,
                                        ...
                                        stagegraph_core::module::BevyCameraMode::Static {
                                            position,
                                            look_at,
