...
This crate is primarily used by the main `stagegraph` application to power 3D modules and visualizers. It is not intended to be used as a standalone application.
...
- `stagegraph-core` (Core data structures)
