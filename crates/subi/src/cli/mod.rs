...
#[derive(Parser, Debug)]
#[command(author, version, about = "SubI - Professional Projection Mapping Software", long_about = None)]
/// Command-line arguments for SubI.
pub struct CliArgs {
    /// Operating mode
    ...
    #[arg(long, default_value = "SUBI-MASTER")]
    pub source: String,
    ...
    #[arg(long, env = "SUBI_VISUAL_CAPTURE_OUTPUT_DIR")]
    pub screenshot_dir: Option<String>,
}

#[derive(ValueEnum, Clone, Debug, PartialEq, Eq)]
/// Execution mode for SubI.
pub enum Mode {
    /// Full SubI Editor and Rendering
    Editor,
...
mod tests {
    ...
    fn test_cli_automation_mode_parsing() {
        ...
        assert_eq!(
            ...
            Some("/tmp/subi-screenshots")
        );
    }

    #[test]
    fn test_cli_automation_mode_env_fallback() {
        std::env::set_var("SUBI_VISUAL_CAPTURE_OUTPUT_DIR", "/tmp/env-dir");

        let args = vec!["subi", "--mode", "automation"];
        ...
        std::env::remove_var("SUBI_VISUAL_CAPTURE_OUTPUT_DIR");
    }
}
