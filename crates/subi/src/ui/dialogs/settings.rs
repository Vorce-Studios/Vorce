...
use subi_render::WgpuBackend;
use subi_ui::core::config::{AppLogLevel, ToolbarMetricMode};
use subi_ui::{AppUI, UIAction};
        ...
        egui::ScrollArea::vertical().show(ui, |ui| {
            ...
            if active_tab == 0 {
                ...
                let mut metric_row = |ui: &mut egui::Ui,
                                      label: &str,
                                      config: &mut subi_ui::core::config::ToolbarMetricConfig,
                                      id: &str| {
                    ui.horizontal(|ui| {
            ...
            if active_tab == 1 {
                ...
                ui.horizontal(|ui| {
                    ...
                    use subi_ui::core::config::AnimationProfile;
                ...
                egui::Grid::new("perf_grid")
                    ...
                    .show(ui, |ui| {
                        ...
                        egui::ComboBox::from_id_salt("vsync_select")
                            ...
                            .show_ui(ui, |ui| {
                                use subi_ui::core::config::VSyncMode;
            ...
            if active_tab == 3 {
                ...
                ui.horizontal(|ui| {
                    ...
                    egui::ComboBox::from_id_salt("meter_select")
                        ...
                        .show_ui(ui, |ui| {
                            use subi_ui::core::config::AudioMeterStyle;
