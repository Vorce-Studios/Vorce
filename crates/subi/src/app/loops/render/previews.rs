        ...
        app.cached_output_infos = app
            ...
            .filter_map(|(mid, part)| {
                if let subi_core::module::ModulePartType::Output(
                    subi_core::module::OutputType::Projector { id, .. },
                ) = &part.part_type
                {
                ...
                module
                    ...
                    .map(|part| {
                        let media_path = match &part.part_type {
                            subi_core::module::ModulePartType::Source(
                                subi_core::module::SourceType::MediaFile { path, .. }
                                | subi_core::module::SourceType::VideoUni { path, .. }
                                | subi_core::module::SourceType::ImageUni { path, .. },
                            ) if !path.trim().is_empty() => Some(path.clone()),
                            subi_core::module::ModulePartType::Source(
                                subi_core::module::SourceType::VideoMulti { shared_id, .. }
                                | subi_core::module::SourceType::ImageMulti { shared_id, .. },
                            ) => app
                                .state
                                .module_manager
                                .shared_media
