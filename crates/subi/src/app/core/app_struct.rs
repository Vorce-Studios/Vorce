...
// use subi_media::player::VideoPlayer;
use subi_render::{
...
pub struct StartupAnimationState {
    ...
    pub player: Option<subi_media::VideoPlayer>,
...
pub struct App {
    ...
    /// The audio analyzer.
    pub audio_analyzer: subi_core::audio::AudioAnalyzer,
    ...
    #[cfg(feature = "ndi")]
    pub ndi_receivers:
        std::collections::HashMap<subi_core::module::ModulePartId, subi_io::ndi::NdiReceiver>,
    /// NDI Senders for module outputs
    #[cfg(feature = "ndi")]
    pub ndi_senders:
        std::collections::HashMap<subi_core::module::ModulePartId, subi_io::ndi::NdiSender>,
    ...
    #[allow(dead_code)]
    pub shader_graph_manager: subi_render::ShaderGraphManager,
    ...
    pub recent_effect_configs: subi_core::RecentEffectConfigs,
    ...
    pub bevy_runner: Option<subi_bevy::BevyRunner>,
}
