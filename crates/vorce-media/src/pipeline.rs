...
mod tests {
    ...
    fn test_frame_scheduler() {
        ...
        let frame1 = PipelineFrame {
            frame: vorce_io::VideoFrame {
                data: vorce_io::format::FrameData::Cpu(Arc::new(vec![])),
                format: vorce_io::VideoFormat {
                    width: 100,
                    height: 100,
                ...
                metadata: vorce_io::FrameMetadata::default(),
            },
            sequence: 1,
    ...
    fn test_pipeline_with_test_pattern() {
        ...
        let decoder = crate::test_pattern_decoder::TestPatternDecoder::new(640, 480, Duration::from_secs(1), 30.0);
