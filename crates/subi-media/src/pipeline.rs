...
mod tests {
    ...
    fn test_frame_scheduler() {
        ...
        let frame1 = PipelineFrame {
            frame: subi_io::VideoFrame {
                data: subi_io::format::FrameData::Cpu(Arc::new(vec![])),
                format: subi_io::VideoFormat {
                    width: 100,
                    height: 100,
                    pixel_format: subi_io::PixelFormat::RGBA8,
                    frame_rate: 60.0,
                },
                timestamp: Duration::ZERO,
                metadata: subi_io::FrameMetadata::default(),
            },
            sequence: 1,
