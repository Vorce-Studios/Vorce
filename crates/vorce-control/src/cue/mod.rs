...
//!
//! ```rust
//! use vorce_control::cue::{Cue, CueList, LayerState};
...
//!
//! ```rust
//! use vorce_control::cue::{Cue, triggers::MidiTrigger};
//! use std::time::Duration;
//!
...
pub use triggers::{MidiTrigger, MidiTriggerType, OscTrigger, TimeTrigger, TimelineTrigger};
