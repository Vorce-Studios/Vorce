//! Professional video I/O for SubI.
//!
//! This crate provides video input/output capabilities for SubI, including support for:
//!
...
//!
//! ```ignore
//! use subi_io::{VideoSink, VideoFrame};
//! use subi_io::stream::RtmpStreamer;
//! use subi_io::format::VideoFormat;
//!
...
//!
//! ```ignore
//! use subi_io::converter::FormatConverter;
//! use subi_io::format::{VideoFormat, VideoFrame, PixelFormat};
//!
...
mod tests {
    ...
    fn test_feature_info_display() {
        ...
        assert!(display.contains("SubI I/O"));
