...
Professional video input/output subsystem for SubI. This crate manages video sources (capture cards, network streams) and sinks (projectors, streams).
...
- **Virtual Camera**: Output SubI content as a virtual webcam.
