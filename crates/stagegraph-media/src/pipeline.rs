...
pub struct PipelineFrame {
    pub frame: stagegraph_io::VideoFrame,
    pub sequence: u64,
...
mod tests {
    ...
    fn test_frame_scheduler() {
        ...
        let frame1 = PipelineFrame {
            frame: stagegraph_io::VideoFrame {
                data: stagegraph_io::format::FrameData::Cpu(Arc::new(vec![])),
                format: stagegraph_io::VideoFormat {
                    width: 100,
                    height: 100,
                    pixel_format: stagegraph_io::PixelFormat::RGBA8,
                    frame_rate: 60.0,
                },
                timestamp: Duration::ZERO,
                metadata: stagegraph_io::FrameMetadata::default(),
            },
            sequence: 1,
