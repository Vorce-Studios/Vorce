        ...
        if let Some(active_id) = ui_state.module_canvas.active_module_id {
            if *mod_id == active_id {
                ...
                if let Some(texture) = app.texture_pool.get_texture(&tex_name) {
                    ...
                    let tex_id = if let Some((cached_id, _cached_view)) =
                        app.preview_texture_cache.get(&(*mod_id, *part_id))
                    {
                        ...
                        *cached_id
                        ...
                        app.preview_texture_cache
                            .insert((*mod_id, *part_id), (id, view.clone()));
                        id
                    };
