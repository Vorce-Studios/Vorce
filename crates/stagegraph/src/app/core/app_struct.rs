...
// use stagegraph_media::player::VideoPlayer;
...
pub struct StartupAnimationState {
    ...
    pub player: Option<stagegraph_media::VideoPlayer>,
...
pub struct App {
    ...
    /// The audio analyzer.
    pub audio_analyzer: stagegraph_core::audio::AudioAnalyzer,
    ...
    #[cfg(feature = "ndi")]
    pub ndi_receivers:
        std::collections::HashMap<stagegraph_core::module::ModulePartId, stagegraph_io::ndi::NdiReceiver>,
    /// NDI Senders for module outputs
    #[cfg(feature = "ndi")]
    pub ndi_senders:
        std::collections::HashMap<stagegraph_core::module::ModulePartId, stagegraph_io::ndi::NdiSender>,
    ...
    #[allow(dead_code)]
    pub shader_graph_manager: stagegraph_render::ShaderGraphManager,
    ...
    pub recent_effect_configs: stagegraph_core::RecentEffectConfigs,
    ...
    pub bevy_runner: Option<stagegraph_bevy::BevyRunner>,
}
