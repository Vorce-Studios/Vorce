        ...
        app.cached_output_infos = app
            ...
            .filter_map(|(mid, part)| {
                if let stagegraph_core::module::ModulePartType::Output(
                    stagegraph_core::module::OutputType::Projector { id, .. },
                ) = &part.part_type
                {
                ...
                module
                    ...
                    .map(|part| {
                        let media_path = match &part.part_type {
                            stagegraph_core::module::ModulePartType::Source(
                                stagegraph_core::module::SourceType::MediaFile { path, .. }
                                | stagegraph_core::module::SourceType::VideoUni { path, .. }
                                | stagegraph_core::module::SourceType::ImageUni { path, .. },
                            ) if !path.trim().is_empty() => Some(path.clone()),
                            stagegraph_core::module::ModulePartType::Source(
                                stagegraph_core::module::SourceType::VideoMulti { shared_id, .. }
                                | stagegraph_core::module::SourceType::ImageMulti { shared_id, .. },
                            ) => app
                                .state
                                .module_manager
                                .shared_media
