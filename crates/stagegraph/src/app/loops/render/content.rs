use anyhow::Result;
use stagegraph_core::module::OutputType::Projector;
...
pub(crate) struct RenderContext<'a> {
    ...
    pub render_ops: &'a Vec<(
        ...
        stagegraph_core::module_eval::RenderOp,
    )>,
    pub output_manager: &'a stagegraph_core::output::OutputManager,
    pub edge_blend_renderer: &'a Option<stagegraph_render::EdgeBlendRenderer>,
    pub color_calibration_renderer: &'a Option<stagegraph_render::ColorCalibrationRenderer>,
    ...
    pub mesh_renderer: &'a mut stagegraph_render::MeshRenderer,
    pub effect_chain_renderer: &'a mut stagegraph_render::EffectChainRenderer,
    pub preview_effect_chain_renderer: &'a mut stagegraph_render::EffectChainRenderer,
    pub shader_graph_manager: &'a stagegraph_render::ShaderGraphManager,
    pub texture_pool: &'a stagegraph_render::TexturePool,
    pub _dummy_view: &'a Option<std::sync::Arc<wgpu::TextureView>>,
    pub mesh_buffer_cache: &'a mut stagegraph_render::MeshBufferCache,
...
pub(crate) fn render_content(
    ...
    let mut target_ops: Vec<(u64, stagegraph_core::module_eval::RenderOp)> = ctx
        .render_ops
        .iter()
        ...
        if let Some(edge_blend_renderer) = ctx.edge_blend_renderer.as_ref() {
            ...
            *texture_bind_group = edge_blend_renderer.create_texture_bind_group(intermediate_view);
            ...
            let config_to_use = if use_edge_blend {
                ...
                stagegraph_core::EdgeBlendConfig::default()
            };
