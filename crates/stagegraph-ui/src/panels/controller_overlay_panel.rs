...
impl ControllerOverlayPanel {
    ...
    fn message_matches_config(
        message: &MidiMessage,
        config: &stagegraph_control::midi::MidiConfig,
    ) -> bool {
        ...
        match (message, config) {
            (
                ...
                stagegraph_control::midi::MidiConfig::Cc {
                    channel: cfg_ch,
                    controller: cfg_cc,
                },
            ...
            (
                ...
                stagegraph_control::midi::MidiConfig::CcRelative {
                    channel: cfg_ch,
                    controller: cfg_cc,
                },
            ) => *channel == *cfg_ch && *controller == *cfg_cc,
            (
                ...
                stagegraph_control::midi::MidiConfig::Note {
                    channel: cfg_ch,
                    note: cfg_note,
                },
