...
use egui::Ui;
use stagegraph_core::{Layer, Transform};
...
pub fn render_layer_inspector(
    ...
    transform: &Transform,
    _index: usize,
    first_mapping: Option<&stagegraph_core::mapping::Mapping>,
    i18n: &LocaleManager,
            ...
            .show(ui, |ui| {
                if let Some(mapping) = first_mapping {
                    ...
                    if *last_mesh_edit_id != Some(mapping.id) {
                        *last_mesh_edit_id = Some(mapping.id);
                        ...
                        match &mapping.mesh.mesh_type {
                            stagegraph_core::mesh::MeshType::Quad => {
                    ...
                    if let Some(_edit_action) = mesh_editor.ui(ui) {
                        ...
                        if new_mesh.mesh_type == stagegraph_core::mesh::MeshType::Quad {
                    ...
                    if ui.button("Reset Mesh").clicked() {
                        let mut reset_mesh = stagegraph_core::Mesh::quad();
