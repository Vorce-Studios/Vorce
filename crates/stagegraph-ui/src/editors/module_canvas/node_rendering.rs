use crate::UIAction;
use egui::Ui;
use stagegraph_core::module::EffectType as ModuleEffectType;
...
impl ModuleCanvas {
    pub fn sync_mesh_editor_to_current_selection(
        ...
        part: &stagegraph_core::module::ModulePart,
    ) {
    ...
    pub fn apply_mesh_editor_to_selection(
        ...
        part: &mut stagegraph_core::module::ModulePart,
    ) {
    ...
    pub fn render_mesh_editor_ui(
        ...
        last_mesh_edit_id: &mut Option<u64>,
        ui: &mut Ui,
        mesh: &mut stagegraph_core::module::MeshType,
    ...
    pub fn render_inspector_for_part(
        ...
        module_id: stagegraph_core::module::ModuleId,
