...
use stagegraph_core::module::{ModulePartId, ModulePartType, ModuleSocketType, TriggerType};
use std::borrow::Cow;
...
pub type PresetPart = (
    stagegraph_core::module::ModulePartType,
    (f32, f32),
    Option<(f32, f32)>,
);
...
pub enum CanvasAction {
    AddPart {
        ...
        part_data: stagegraph_core::module::ModulePart,
    },
    UpdatePart {
        part_id: ModulePartId,
        before: Box<stagegraph_core::module::ModulePart>,
        after: Box<stagegraph_core::module::ModulePart>,
    },
    DeletePart {
        part_data: stagegraph_core::module::ModulePart,
    },
    ...
    AddConnection {
        connection: stagegraph_core::module::ModuleConnection,
    },
    DeleteConnection {
        connection: stagegraph_core::module::ModuleConnection,
    },
...
impl NodeTemplateTrait for MyNodeTemplate {
    ...
    fn user_data(&self, _user_state: &mut Self::UserState) -> Self::NodeData {
        MyNodeData {
            ...
            part_type: stagegraph_core::module::ModulePartType::Trigger(TriggerType::Beat), // Mock
            original_part_id: 0,
        }
    }
