...
#[cfg(feature = "ndi")]
use stagegraph_io::ndi::NdiSource;
#[cfg(feature = "ndi")]
use std::sync::mpsc;
...
pub struct ModuleCanvas {
    ...
    pub clipboard: Vec<(stagegraph_core::module::ModulePartType, (f32, f32))>,
    /// Search filter text
    ...
    pub diagnostic_issues: Vec<stagegraph_core::diagnostics::ModuleIssue>,
    ...
    pub hue_bridges: Vec<stagegraph_control::hue::api::discovery::DiscoveredBridge>,
    /// Channel for Hue discovery results
    pub hue_discovery_rx: Option<
        std::sync::mpsc::Receiver<
            Result<Vec<stagegraph_control::hue::api::discovery::DiscoveredBridge>, String>,
        >,
    >,
    ...
    pub edit_snapshot: Option<stagegraph_core::module::ModulePart>,
}
