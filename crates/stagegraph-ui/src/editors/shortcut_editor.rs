...
use stagegraph_control::shortcuts::Shortcut;
...
impl ShortcutEditor {
    ...
    pub fn new() -> Self {
        Self {
            ...
            bindings: stagegraph_control::shortcuts::DefaultShortcuts::all(),
        }
    }
    ...
    fn ui(&mut self, ui: &mut Ui, i18n: &LocaleManager) {
        ...
        ui.horizontal(|ui| {
            if ui.button(i18n.t("btn-reset-defaults")).clicked() {
                self.bindings = stagegraph_control::shortcuts::DefaultShortcuts::all();
            }
