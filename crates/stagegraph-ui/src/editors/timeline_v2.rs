...
//!
//! Multi-track timeline with keyframe animation, using stagegraph_core::animation types.

use crate::theme::colors;
use crate::widgets::hold_to_action_button;
use egui::{Color32, Pos2, Rect, Sense, Stroke, Ui, Vec2};
use stagegraph_core::animation::AnimValue;
use stagegraph_core::effect_animation::EffectParameterAnimator;
use stagegraph_core::module::ModuleId;
    ...
    pub fn ui(
            ...
            egui::ComboBox::from_id_salt("playback_mode_combo")
                ...
                .show_ui(ui, |ui| {
                    if ui
                        .selectable_value(
                            &mut current_mode,
                            stagegraph_core::animation::PlaybackMode::Loop,
                            "Loop",
                        )
                        .clicked()
                    {
                    ...
                    if ui
                        .selectable_value(
                            &mut current_mode,
                            stagegraph_core::animation::PlaybackMode::PingPong,
                            "PingPong",
                        )
                        .clicked()
                    {
                    ...
                    if ui
                        .selectable_value(
                            &mut current_mode,
                            stagegraph_core::animation::PlaybackMode::OneShot,
                            "OneShot",
                        )
                        .clicked()
                    {
        ...
        egui::ScrollArea::both().show(ui, |ui| {
            ...
            let mut track_groups: std::collections::BTreeMap<
                String,
                Vec<&stagegraph_core::animation::AnimationTrack>,
